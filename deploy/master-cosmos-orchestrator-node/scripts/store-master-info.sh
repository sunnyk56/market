...
BUCKET_MASTER_CHAIN_DATA_VALIDATOR_PHRASE="master/validator-phrases"
BUCKET_MASTER_CHAIN_DATA_ORCHESTRATOR_PHRASE="master/orchestrator-phrases"
BUCKET_MASTER_CHAIN_DATA_VALIDATOR_ETH_KEYS="master/validator-eth-keys"
...
touch $BUCKET_MASTER_CHAIN_DATA_VALIDATOR_PHRASE
touch $BUCKET_MASTER_CHAIN_DATA_ORCHESTRATOR_PHRASE
touch $BUCKET_MASTER_CHAIN_DATA_VALIDATOR_ETH_KEYS
echo "Copying genesis file"
cp $GRAVITY_GENESIS_FILE $BUCKET_MASTER_GENESIS_FILE
cp $GRAVITY_SEED_FILE $BUCKET_MASTER_SEED
cp /validator-phrases $BUCKET_MASTER_CHAIN_DATA_VALIDATOR_PHRASE
cp /orchestrator-phrases $BUCKET_MASTER_CHAIN_DATA_ORCHESTRATOR_PHRASE
cp /validator-eth-keys $BUCKET_MASTER_CHAIN_DATA_VALIDATOR_ETH_KEYS
