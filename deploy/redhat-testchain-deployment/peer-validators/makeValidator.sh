...
$GRAVITY $GRAVITY_HOME_FLAG tx bank send $($GRAVITY $GRAVITY_HOME_FLAG keys show -a orch1 $GRAVITY_KEYRING_FLAG) $($GRAVITY $GRAVITY_HOME_FLAG keys show -a $GRAVITY_VALIDATOR_NAME $GRAVITY_KEYRING_FLAG) 1000000000stake $GRAVITY_CHAINID_FLAG $GRAVITY_KEYRING_FLAG -y

# Transfer some footoken to new validator
$GRAVITY $GRAVITY_HOME_FLAG tx bank send $($GRAVITY $GRAVITY_HOME_FLAG keys show -a orch1 $GRAVITY_KEYRING_FLAG) $($GRAVITY $GRAVITY_HOME_FLAG keys show -a $GRAVITY_VALIDATOR_NAME $GRAVITY_KEYRING_FLAG) 1000000000footoken $GRAVITY_CHAINID_FLAG $GRAVITY_KEYRING_FLAG -y
